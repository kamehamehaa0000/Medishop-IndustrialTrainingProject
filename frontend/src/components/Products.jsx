...
import { useCategories, useProductsByCategory } from '../hooks/useProduct'
...
const Products = () => {
  ...
  return (
    <div id="menu" className="w-full bg-[#] my-4 rounded-3xl mt-10">
      ...
      <div className="my-4 text-base font-medium flex flex-wrap">
        <button
          onClick={() => {
      ...
      <div className="grid grid-cols-2 px-4 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-4">
