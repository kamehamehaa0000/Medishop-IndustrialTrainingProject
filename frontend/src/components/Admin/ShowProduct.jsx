                  ...
                  <div className="flex w-fit p-4 max-w-lg font-semibold text-base">
                    <div className="w-1/2">
                      <div className="rounde bg-[#FFFFFF] px-2 w-full">
                        ...
                        <h3 className="text-xs text-left font-semibold my-1 ">
                          {product.description}
                        </h3>{' '}
                    ...
                    <div className=" w-1/2 relative overflow-hidden ">
                      <img
                        ...
                        className=" max-h-60 w-full transition-all ease-in-out duration-500 hover:scale-110  object-cover object-center"
                      />{' '}
